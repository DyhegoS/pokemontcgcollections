...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CardCollections cc1 = new CardCollections(null, "VioletScarlet", u1);
		CardCollections cc2 = new CardCollections(null, "LeafGreen", u2);
		CardCollections cc3 = new CardCollections(null, "Platinum", u1);
